/*
🏷️ Nama Fitur: Anime Brat
🔖 Info: Ya begitulah
♨️ Type: Plugins `CJS`
✍️ Recode By: SkyWalker
🔗 Sumber: https://whatsapp.com/channel/0029Vb1NWzkCRs1ifTWBb13u
🔗 Sumber Utama: https://whatsapp.com/channel/0029VasjrIh3gvWXKzWncf2P/1291
*/
...
const handler = async (m, { conn, text }) => {
    if (!text) {
        console.log('❌ Tidak ada teks yang dimasukkan.');
        return m.reply('Masukkan teks untuk stiker.');
    }
